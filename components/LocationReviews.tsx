      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            {/* Map Container */}
            <div className="relative bg-gray-200 rounded-2xl overflow-hidden mb-8 h-64 lg:h-80">
              {/* Custom Map Placeholder with Pin */}
              <div className="absolute inset-0 bg-gradient-to-br from-green-100 to-blue-100 flex items-center justify-center">
                ...
                >
                  ...
                  <div className="bg-white px-4 py-2 rounded-lg shadow-lg">
                    <p className="font-semibold text-gray-900">Guwahati Flavors</p>
                    <p className="text-sm text-gray-600">Fancy Bazaar</p>
                  </div>
                </motion.div>
              </div>
              ...
              >
                <div className="bg-white px-4 py-2 rounded-lg shadow-lg">
                  <span className="font-medium text-gray-900">Open in Maps</span>
                </div>
              </motion.button>
            </div>
            ...
            >
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{locationInfo.hours}</p>
